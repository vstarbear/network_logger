...
class NetworkEvent {
  ...
  NetworkEvent.now({this.request, this.response, this.error}) : this.timestamp = DateTime.now();
...
class Headers {
  ...
  Headers.fromMap(Map<String, String> map) : entries = map.entries as List<MapEntry<String, String>>;
